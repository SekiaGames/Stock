...
# 重新下载仓库
rm -rf $HOME/Stock;git clone https://github.com/SekiaGames/Stock $HOME/Stock

#更新仓库推送
docker stop InStock;git -C $HOME/Stock fetch origin && git -C $HOME/Stock reset --hard origin/main;docker restart InStock
```
